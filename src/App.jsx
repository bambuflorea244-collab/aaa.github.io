...
export default function App() {
  ...
  const [expandedFolders, setExpandedFolders] = useState({}); // folder collapse state
  ...
  const folderTree = {};
  folders.forEach((f) => {
    folderTree[f.id] = { ...f, children: [] };
  });
  folders.forEach((f) => {
    if (f.parent_id && folderTree[f.parent_id]) {
      folderTree[f.parent_id].children.push(folderTree[f.id]);
    }
  });
  const rootFolders = Object.values(folderTree).filter((f) => !f.parent_id);
          ...
          <div>
            {childChats.map((chat) => (
              <div className="chat-row" key={chat.id}>
                <button
                  className={
                    "chat-item " + (chat.id === activeChat ? "active" : "")
                  }
                  onClick={() => {
    ...
    <div className="app-shell">
                ...
                {attachments.map((file, i) => (
                  <div key={i} className="attachment-pill">
                    ...
                    <button
                      ...
                      onClick={() =>
                        setAttachments((a) => a.filter((_, x) => x !== i))
                      }
                    >
                      ✖
                    </button>
        ...
        <div className="modal-backdrop" onClick={() => setNewChatModal(false)}>
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-footer">
              <button className="btn" onClick={() => setNewChatModal(false)}>
                Cancel
              </button>
          ...
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-field">
              ...
              <input
                ...
                placeholder={
                  settingsStatus.geminiApiKeySet
                    ? "Already set"
            ...
            <div className="modal-field">
              ...
              <input
                ...
                placeholder={
                  settingsStatus.pythonAnywhereKeySet
                    ? "Already set"
                    : "Enter your PythonAnywhere API key"
                }
              />
            </div>

            <div className="modal-footer">
              <button className="btn" onClick={() => setSettingsModal(false)}>
                Cancel
              </button>
      ...
      {chatSettingsModal && chatSettings && (
        <div
          ...
          onClick={() => setChatSettingsModal(false)}
        >
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-field">
              ...
              <button className="btn btn-sm" onClick={regenerateChatApiKey}>
                🔄 Regenerate key
              </button>
            </div>
            ...
            <div className="modal-footer">
              <button className="btn" onClick={() => setChatSettingsModal(false)}>
                Cancel
              </button>
              <button className="btn btn-primary" onClick={saveChatSettings}>
                Save
              </button>
            </div>
          </div>
